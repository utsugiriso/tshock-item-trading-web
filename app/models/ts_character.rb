class TsCharacter < ApplicationRecord
  ...
  PIGGY_RANGE = (MISC_DYE_RANGE.last...(MISC_DYE_RANGE.last + STORAGE_SLOT_COUNT))
  SAFE_RANGE = (PIGGY_RANGE.last...(PIGGY_RANGE.last + STORAGE_SLOT_COUNT))
  TRASH_RANGE = (SAFE_RANGE.last...(SAFE_RANGE.last + TRASH_SLOT_COUNT))
  FORGE_RANGE = (TRASH_RANGE.last...(TRASH_RANGE.last + STORAGE_SLOT_COUNT))
  VOID_RANGE = (FORGE_RANGE.last...(FORGE_RANGE.last + STORAGE_SLOT_COUNT))
